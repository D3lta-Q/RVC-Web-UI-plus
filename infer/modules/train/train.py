...
# Load the colour-loss formatter using its file path, so it works before
# 'infer' is resolvable as a package (sys.path is set up just above).
import importlib.util as _ilu, pathlib as _pl
_colour_loss_path = _pl.Path(__file__).parent / "colour_loss.py"
_spec = _ilu.spec_from_file_location("colour_loss", _colour_loss_path)
_mod = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_mod)
del _ilu, _pl, _colour_loss_path, _spec, _mod
